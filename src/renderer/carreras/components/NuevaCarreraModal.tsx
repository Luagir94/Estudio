...
export function NuevaCarreraModal({ onSubmit, pending, onClose }: NuevaCarreraModalProps): React.JSX.Element {
  ...
  return (
    <>
      <DialogOverlay>
        <DialogContent role="dialog" aria-label={t('nuevaCarreraModal.dialogLabel')} onDismiss={guard.onDismiss}>
